...
## Project overview
This repository contains KiCad v9 design files and STM32 source code for the HMI board of a Xenon-based strobe light system.
...
## DIRECTORY STRUCTURE
    ...
    ├─ Code               # STM32 project / source code
